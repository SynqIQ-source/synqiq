...
// app/dashboard/heatmap/range-select.tsx and
// app/dashboard/classes/history-window-select.tsx -- kept as its own
// page-local component rather than shared, matching how those two already
// coexist as separate, near-identical components in this codebase.
export function RangeSelect({ range, rangeStart, rangeEnd }: RangeSelectProps) {
